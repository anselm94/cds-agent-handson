/* checksum : 438676ec8783c41af4a5e166298de1ff */
@cds.external : true
...
service OP_API_SALES_ORDER_SRV_0001 {
  ...
  entity A_SalesOrder {
    ...
    @sap.label : 'Name of Last Contact'
    @sap.quickinfo : 'Name of Last Contact Person for Sold-to Party in Sales Doc.'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    SlsDocSo2PLastContactPersnName : String(35);
    @sap.display.format : 'UpperCase'
    @sap.label : 'Tel. No. Last Cntct'
    @sap.quickinfo : 'Tel. No. of Last Contact Person f. Sold-to Party in Sls Doc.'
    @sap.creatable : 'false'
    @sap.updatable : 'false'
    SlsDocSo2PLstCntctPersnTelNmbr : String(16);
  ...
  entity A_SalesOrderBillingPlan {
    ...
    @sap.label : 'Gen. Payment Link'
    @sap.quickinfo : 'Payment by Link - Generate Payment Link'
    PaymentLinkIsRequired : Boolean;
    @sap.display.format : 'UpperCase'
    @sap.label : 'Category'
  ...
  entity A_SalesOrderItem {
    ...
    to_ValueAddedService : Association to many A_SalesOrderValAddedSrvc {  };
  };
  ...
  entity A_SalesOrderValAddedSrvc {
    @sap.display.format : 'NonNegative'
  ...
  entity A_SlsOrdPaymentPlanItemDetails {
    ...
    @sap.label : 'Transaction/Payt ID'
    @sap.quickinfo : 'Transaction/Payment ID of SAP Digital Payments'
    DigitalPaymentTransID : String(44);
    @sap.unit : 'AuthorizationCurrency'
    @sap.label : 'Billing Value'
    @sap.quickinfo : 'Value to be billed/calc. on date in billing/invoice plan'
